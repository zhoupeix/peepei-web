  ...
  <div class="about">
    ...
    <el-card>
      <el-row :gutter="20">
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-input placeholder="请输入物品名称" v-model="queryInfo.query" clearable @clear="fetch">
        ...
        <el-col :span="6">
          <div class="grid-content bg-purple">
          <el-button type='primary' @click="$router.push('/item/create')" class="el-icon-plus">添加物品</el-button>
          </div>
          </el-col>
      </el-row>
      ...
      <el-table :data="tableData" style="width: 100%" max-height="650">
        ...
        <el-table-column prop="name" label="物品名称" width="250">
        </el-table-column>
        <el-table-column prop="icon" label="物品图标" width="250">
          <template slot-scope="scope">
            <img :src="scope.row.icon" alt="" style="height:2.5rem;" />
          </template>
        </el-table-column>
