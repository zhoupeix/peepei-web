  ...
  <div class="about">
    ...
    <el-card>
      <el-row :gutter="20">
        <el-col :span="8">
          <div class="grid-content bg-purple">
            <el-input placeholder="请输入英雄名称" v-model="queryInfo.query" clearable @clear="fetch">
        ...
        <el-col :span="6">
          <div class="grid-content bg-purple">
            <el-button type="primary" @click="$router.push('/hero/create')" class="el-icon-plus"
              >添加英雄</el-button>
          </div>
        </el-col>
      </el-row>
      <el-table :data="tableData" style="width: 100%" max-height="650">
        ...
        <el-table-column prop="title" label="英雄称号" width="150">
        </el-table-column>
        <el-table-column prop="icon" label="英雄图标" width="250">
